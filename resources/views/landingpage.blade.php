...
<head>
    ...
    <title>THE CORRALON</title>
    <img src="/landingpage/img/portada.jpg" alt="">
    <img class="img-responsive" src="landingpage\img\portada.jpg" alt="">
    <!-- Bootstrap Core CSS -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    ...
                    <p>
                    THE CORRALON es una empresa de gruas en la cual se resuelven problematicas
                    del dia a dia.
                    </p>
                </div>
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="landingpage\img\autos.jpg" alt="">
            ...
            <div class="row">
                <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
                    ...
                    <p>
                        ...
                        <ul>
                            <li>Remolcamiento</li>
                            <li>Recoleccion de vehiculos varados</li>
                            <li>Multas</li>
                            <li>Obstruccion de la via publica</li>
                ...
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    <img class="img-responsive" src="landingpage\img\grua.jpg" alt="">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    ...
                    <p>Nos ubicamos en Guadalajara Jalisco Mexico por el momento.
                    </p>
                </div>
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
